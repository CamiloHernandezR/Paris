...
class ArticulosControlador extends ArticulosModelo{
  public function seleccionarArticulosControlador(){
    $respuesta=ArticulosModelo::seleccionarArticulosModelo("articulos");
