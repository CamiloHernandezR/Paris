<footer class="row" id="contactenos">
	...
	<h1 class="text-center text-info"><b>Inicia sesión</b></h1>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="formulario" >
		...
		<h1>Inicia sesión</h1>
			...
			<form onsubmit="return  validarIngreso()">
			    <input type="text" class="form-control"  placeholder="Usuario" id="usuarioIngresar">

			    <input type="password" class="form-control" placeholder="contraseña" id="passIngresar">

					<p><a href="registrate">No tienes una cuenta Unete</a> </p>
